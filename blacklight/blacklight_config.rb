...
# FIXME: we haven't got to this bit yet
...
# FIXME: don't know what any of this does, so comment out for the moment ...
...
#  }
  ...
  config[:sort_fields] ||= []
  config[:sort_fields] << ['relevance', 'score desc, title asc']
